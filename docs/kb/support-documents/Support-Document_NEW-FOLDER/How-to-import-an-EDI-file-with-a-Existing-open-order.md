...
source_path: Support Document_NEW FOLDER/How to import an EDI file with a Existing open order.docx
extracted: 2026-04-23T02:31:45.154Z
sha: ab247fc4911e
category: Inventory & Items
tags: howto,inventory
---

# How to import an EDI file with a Existing open order

**How to import an EDI file with an Existing open order?**

If stores have an existing order and want to compare order and receive qty then they can use the 'existing open order' option.
...
- Verify that on PO -\> Open order -\> Open order details page.
...
![](media/image3.png){width="6.5in" height="3.0in"}
...
![](media/image4.png){width="6.5in" height="2.986111111111111in"}
