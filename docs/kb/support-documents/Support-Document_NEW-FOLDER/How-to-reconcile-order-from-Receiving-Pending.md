...
**[How to reconcile order from Receiving Pending?]{.underline}**
...
- It will display order details like Created Date & time, OPN#, title, invoice, delivery date & time, user and status of an order in the action field.
...
![](media/image4.png){width="3.3125in" height="2.46875in"}
