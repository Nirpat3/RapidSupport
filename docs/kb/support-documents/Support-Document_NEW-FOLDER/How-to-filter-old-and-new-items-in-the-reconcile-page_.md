...
**How to filter old and new items in the reconcile page?**

If stores have lots of items in the reconcile page then they can filter new and old items.
...
- In the reconcile page, click on the option for filter items.

- From the list, click on 'new items'.

- New items would be displayed.
